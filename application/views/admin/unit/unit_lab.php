                            ...
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                    <a data-toggle = "modal" data-id="" class="passing" >
                                        <button type="button" class="btn mb-2 btn-success btn-md"  data-toggle="modal" data-target="#add_lab">
                                ...
                                <div class="table-responsive">
                                    <table class="mb-0 table table-striped" data-page-length='100' id="example">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 80%;">Laboratorium</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle = "modal" data-id="<?php echo $row->id_lab ?>" data-nama="<?php echo $row->nama_lab ?>" class="passing2" >
                                                    <button type="button" class="btn mb-2 btn-primary btn-md"  data-toggle="modal" data-target="#edit_lab">
