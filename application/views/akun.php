<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Kelola Akun
                                        <div class="page-title-subheading">Silakan <span class="text-primary"><b>lengkapi akun Anda</b></span> sebelum menggunakan layanan.
                                        </div>
                                    </div>
                                </div>
                         ...
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo site_url('ubah-data-akun') ?>" enctype="multipart/form-data" >
                                    <div class="position-relative row form-group"><label for="username" class="col-sm-2 col-form-label"><?php 
                                        ...
                                        <div class="position-relative row form-group"><label for="nama" class="col-sm-2 col-form-label">Nama</label>
                                            <div class="col-sm-10"><input name="nama" required id="nama" value="<?php echo $this->session->userdata('name') ?>" type="text" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="hp" class="col-sm-2 col-form-label">No HP/WA</label>
                                            <div class="col-sm-10"><input name="hp" required id="hp" value="<?php echo $this->session->userdata('hp') ?>" type="text" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-10"><input name="email" required id="exampleEmail" value="<?php echo $this->session->userdata('email') ?>" type="email" class="form-control"></div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="exampleEmail" class="col-sm-2 col-form-label">Foto</label>
                                            <div class="col-sm-2">
                                                <img src="<?php echo $this->session->userdata('foto') ?>" class="img-responsive center-block rounded" style="border: 1px solid #999; width: 120px; height: 160px; margin:0 auto;">
                                            </div>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="position-relative row form-group"><label for="ttd" class="col-sm-2 col-form-label">Tanda Tangan Digital</label>
                                            <div class="col-sm-4">
                                            <canvas style="border: 1px solid #aaa; height: 200px;" id="signature-pad" class="signature-pad col-sm-12" height="200px"></canvas>
                                            
                                            </div>
                                            <div class="col-sm-4">
                                            <img src='<?php if($this->session->userdata('ttd') == "")
                                                echo base_url('assets/images/no-signature.jpg');
                                            else
                                                echo $this->session->userdata('ttd');
