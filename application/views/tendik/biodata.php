                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo site_url('tendik/ubah-data-biodata') ?>" >
                                        ...
                                        <div class="position-relative row form-group"><label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
                                            <div class="col-sm-10">
                                            <textarea name="jalan" required id="jalan" class="form-control" placeholder="Contoh: Jl. Soekarno Hatta Gg. Bypass Raya No. 103 RT 01 RW 04"><?php echo $biodata->jalan ?></textarea>
                                            </div>
                                        ...
                                        <div class="position-relative row form-group"><label for="alamat" class="col-sm-2 col-form-label"></label>
                                            ...
                                            <div class="col-sm-3">
                                            <input name="kode_pos" required id="kode_pos" value="<?php echo $biodata->kode_pos ?>" type="text" placeholder="Contoh: 35144" data-inputmask="'mask': '99999'" im-insert="true" class="form-control input-mask-trigger">
                                            </div>
