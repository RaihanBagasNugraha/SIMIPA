                                ...
                                <div class="table-responsive">
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-top">
                                                    <a data-toggle = "modal" data-id="<?php echo $row->id_meta ?>" class="verifikasi">
                                                        <button style="width: 80px;" type="button" class="mb-2 btn btn-primary btn-sm"  data-toggle="modal" data-target="#verifikasilab">
                                                            Verifikasi
                                                        </button>
                                                    </a>
