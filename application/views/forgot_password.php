                        ...
                        <div class="mx-auto app-login-box col-sm-12 col-md-8 col-lg-6">
                            ...
                            <div>
                                <form class="">
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="position-relative form-group"><label for="exampleEmail" class="">Email</label><input name="email" id="exampleEmail" placeholder="Ketik email..." type="email" class="form-control"></div>
                                        </div>
                                    </div>
