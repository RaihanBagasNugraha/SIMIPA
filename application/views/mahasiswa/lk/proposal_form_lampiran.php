...
<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Kelola Berkas Proposal Kegiatan
                                ...
                                <div class="table-responsive">
                                                    <table class="mb-0 table table-striped">
                                                        ...
                                                        <?php $nama_berkas = $this->ta_model->get_berkas_name($row->jenis_berkas); ?>
                                                            ...
                                                            <a data-toggle = "modal" data-id="<?php echo $row->id."#$#$".$nama_berkas."#$#$".$row->proposal_id."#$#$".$row->file ?>" class="passingIDs">
                                                            <button style="width: 60px;" type="button" class="btn mb-1 btn-danger btn-sm aksi"  data-toggle="modal" data-target="#delBerkasProposal">
                                                                Hapus
                                                            </button>
                                                            </a>
                                                            </td>
                            ...
                            <div class="col-md-4">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo site_url('mahasiswa/tambah_berkas_proposal') ?>" enctype="multipart/form-data" >
