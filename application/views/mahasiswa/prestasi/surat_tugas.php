...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                <form method="post" action="<?php echo site_url('mahasiswa/prestasi/surat-tugas-form') ?>" >
                                    ...
                                    <div class="position-relative row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="jenis" required class=" form-control">
                                                ...
                                                <option value="Individu">Surat Tugas Individu</option>
                                                <option value="Kelompok">Surat Tugas Tim/Kelompok</option>
                                            </select>
                                        </div>
                                    </div>
