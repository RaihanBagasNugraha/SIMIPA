...
<div class="app-page-title">
                        ...
                        <div class="col-md-8">
                         <div class="main-card mb-3 card">
                            ...
                            <form method="post" action="<?php echo site_url("mahasiswa/prestasi/surat-tugas-form/simpan") ?>" >
                            <?php 
                                if($aksi == "perbaiki"){
                                    $aksi_form = "perbaiki";
                                }else{
                            ...
                            <div class="col-md-4">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo site_url("mahasiswa/prestasi/surat-tugas-form/unggah") ?>" enctype="multipart/form-data" >
                                        <?php 
                                            if($aksi == "perbaiki"){
                                                $aksi_form = "perbaiki";
                                            }else{
