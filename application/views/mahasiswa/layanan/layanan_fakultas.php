                                    ...
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                //surat tugas
                                                elseif($row->id_layanan_fakultas == 32 || $row->id_layanan_fakultas == 33){
                                                    echo "<a href=".site_url('/mahasiswa/prestasi')." class='btn-wide mb-2 btn btn-primary btn-sm'>Ajukan</a>";
                                                }
                                                //form hardcopy
