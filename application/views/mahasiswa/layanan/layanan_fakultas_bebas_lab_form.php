...
<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Kelola Berkas Lampiran Form Layanan Bebas Lab
                        ...
                        <div class="col-md-8">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="table-responsive">
                                                    <table class="mb-0 table table-striped">
                                                        ...
                                                        <?php $nama = $this->ta_model->get_berkas_name($row->jenis_berkas); ?>
                                                            ...
                                                            <a data-toggle = "modal" data-id="<?php echo $row->id."#$#$".$nama."#$#$".$row->id_bebas_lab."#$#$".$row->file ?>" class="passingIDs">
                                                            <button style="width: 60px;" type="button" class="btn mb-1 btn-danger btn-sm aksi"  data-toggle="modal" data-target="#delBerkaslab">
                                                                Hapus
                                                            </button>
                                                            </a>
                                                            </td>
                            ...
                            <?php if($seg == 'tambah'){ ?>
                            <form method="post" action="<?php echo site_url('mahasiswa/simpan-data-lab') ?>" >
                                    <?php 
                            ...
                            <div class="col-md-4">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo site_url('mahasiswa/tambah-berkas-lab') ?>" enctype="multipart/form-data" >
                                        ...
                                        <input type="hidden" name="id_bebas" value="<?php echo $this->input->get('id') ?>">
                                            <div class="position-relative row form-group">
                                                <div class="col-sm-12">
                                                    <select name="jenis_berkas" class=" form-control">
                                                    <option>-- Pilih Jenis Berkas --</option>
                                                    <?php
                                                    $list = $this->parameter_model->select_jenis_berkas_lab();
                                                    foreach ($list as $row) {
                                                        $select = "";
