...
<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Kelola Berkas Lampiran Beasiswa
                                ...
                                <div class="table-responsive">
                                                    <table class="mb-0 table table-striped">
                                                        ...
                                                        <?php $nama_berkas = $this->ta_model->get_berkas_name($row->jenis_berkas); ?>
                                                            ...
                                                            <a data-toggle = "modal" data-id="<?php echo $row->id."#$#$".$nama_berkas."#$#$".$row->id."#$#$".$row->file ?>" class="passingIDs">
                                                            <button style="width: 60px;" type="button" class="btn mb-1 btn-danger btn-sm aksi"  data-toggle="modal" data-target="#delBerkasBeasiswa">
                                                                Hapus
                                                            </button>
                                                            </a>
                                                            </td>
                            ...
                            <div class="col-md-4">
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo site_url('mahasiswa/tambah_berkas_beasiswa') ?>" enctype="multipart/form-data" >
                                        <div class="position-relative row form-group">
                                            <div class="col-sm-12">
                                                <input name="nama_berkas" class="form-control" type="text" placeholder="Nama Berkas">
                                            </div>
                                        </div>
                                        <input type="hidden" name="id_beasiswa" value="<?php echo $this->input->get('id') ?>">
                                            <div class="position-relative row form-group">
                                                <div class="col-sm-12">
 ...
 $("select").select2({
        theme: "bootstrap"
                            ...
                            $(document).on("click", ".passingIDs", function () {
                             ...
                             $(".modal-body #IDBeasiswa").val(data[2]);
