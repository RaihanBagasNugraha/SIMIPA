...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                    <form method="post" action="<?php echo site_url('mahasiswa/simpan_beasiswa2') ?>" >
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="hidden" class = "form-control" name = "id_beasiswa"  value="<?php echo $beasiswa->id ?>" /> 
                                        ...
                                        ?>
                                            ...
                                            <div class="position-relative row form-group">
                                                ...
                                                <?php if($tipe == "text"){ 
                                                        if($row->nama == "Nama Beasiswa"){
                                                            $val = $beasiswa->nama;
                                                            $read = "readonly";
                                                        }elseif($row->nama == "Tahun Beasiswa"){
                                                            $val = $beasiswa->tahun;
                                                            $read = "readonly";
                                                        }elseif($row->nama == "Tahun Akademik"){
                                                            $val = $beasiswa->tahun_akademik;
                                                            $read = "readonly";
                                                        }else{
                                                            $val = "";
                                                            $read = "";
                                                ...
                                                ?>
                                                    <div class="col-sm-9">
                                                        <input type="text" <?php echo $read ?> class = "form-control" placeholder="<?php echo $row->placeholder == null ? "" : $row->placeholder ?>" name = "<?php echo $row->id_atribut ?>" value="<?php echo $val ?>"/>                                         
                                                    </div>  
