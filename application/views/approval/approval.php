...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                <form method="post" action="<?php echo site_url('approval/simpan-ta') ?>" >
                                    ...
                                    <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="<?php echo $ta->status; ?>" type ="text" name="status" class="form-control" readonly>
                                    ...
                                    <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <?php
                                                    $lampiran = $this->ta_model->select_lampiran_by_ta($ta->id_pengajuan, $ta->npm);
                                                        if(empty($lampiran)) {
                                                         echo "<i>(Tidak Ada Lampiran)</i>";
                                                        } else {
                                                          echo "<ul style='margin-left: -20px;'>";
                                                          echo "<li><a href=".site_url("mahasiswa/tugas-akhir/tema/form_pdf?jenis=form_penetapan&id=$ta->id_pengajuan").">Form Penetapan</a></li>";
