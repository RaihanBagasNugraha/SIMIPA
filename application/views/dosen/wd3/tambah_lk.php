...
<div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div>Tambah Lembaga Kemahasiswaan
                                        <div class="page-title-subheading">Silahkan isi Data LK.
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                <div class="card-header">Form Tambah Lembaga Kemahasiswaan</div>
                                <div class="card-body">
                                    <form method="post" action="<?php echo site_url('dosen/simpan_lk') ?>" >
                                    
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-3 col-form-label">Nama</label>
                                            <div class="col-sm-9">
                                                <input type="text" required name="nama" value="" placeholder='Nama LK' class='form-control' id="">
                                            </div>
                                        </div>
