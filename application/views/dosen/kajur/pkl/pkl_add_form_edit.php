                                ...
                                <!-- <?php if(empty($status_ta) || ($this->input->get('aksi') == 'ubah' && !empty($this->input->get('id')))) { ?>   -->
                                    <form method="post" action="<?php echo site_url('dosen/struktural/pkl/add-pkl/form/save') ?>" >
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <?php $tahun = date("Y"); ?>
                                                    ...
                                                    <option <?php echo $tahun == $pkl->tahun ? $select : ""; ?> value = "<?php echo $tahun?>"><?php echo $tahun; ?></option>
                                                    <option <?php echo $tahun+1 == $pkl->tahun ? $select : ""; ?> value = "<?php echo $tahun+1; ?>"><?php echo $tahun+1;?></option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select required name="periode" class= "form-control">
                                                    ...
                                                    <option <?php echo  $pkl->periode == "1" ? $select : ""; ?> value = "1">1</option>
                                                    <option <?php echo  $pkl->periode == "2" ? $select : ""; ?> value = "2">2</option>
                                                </select>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <br>
                                            <?php $tl1 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"1"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="1_start" type="date" value="<?php echo $tl1->date_start; ?>"  class="form-control">
                                            </div>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Berakhir</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="1_end" type="date" value="<?php echo $tl1->date_end; ?>" class="form-control">
                                            </div>
                                            <input type="hidden" name="1_id" value = "<?php echo $tl1->id; ?>">
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <br>
                                            <?php $tl2 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"2"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="2_start" type="date" value="<?php echo $tl2->date_start; ?>" class="form-control">
                                               <input name="2_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="2_id" value = "<?php echo $tl2->id; ?>">
                                        </div>

                                         <!-- 3 -->
                                         <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>3. Mulai KP/PKL</b></label>
                                            <br><?php $tl3 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"3"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="3_start" type="date" value="<?php echo $tl3->date_start; ?>" class="form-control">
                                               <input name="3_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="3_id" value = "<?php echo $tl3->id; ?>">
                                        </div>

                                         <!-- 4 -->
                                         <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>4. Batas akhir mengirim proposal rencana kerja</b></label>
                                            <br><?php $tl4 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"4"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="4_start" type="date" value="<?php echo $tl4->date_start; ?>" class="form-control">
                                               <input name="4_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="4_id" value = "<?php echo $tl4->id; ?>">
                                        </div>

                                        <!-- 5 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>5. Batas akhir mengirim Bab I</b></label>
                                            <br><?php $tl5 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"5"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="5_start" type="date" value="<?php echo $tl5->date_start; ?>" class="form-control">
                                               <input name="5_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="5_id" value = "<?php echo $tl5->id; ?>">
                                        </div>

                                        <!-- 6 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>6. Batas akhir mengirim Bab II</b></label>
                                            <br><?php $tl6 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"6"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="6_start" type="date" value="<?php echo $tl6->date_start; ?>" class="form-control">
                                               <input name="6_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="6_id" value = "<?php echo $tl6->id; ?>">
                                        </div>

                                        <!-- 7 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>7. Batas akhir mengirim Bab III</b></label>
                                            <br><?php $tl7 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"7"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="7_start" type="date" value="<?php echo $tl7->date_start; ?>" class="form-control">
                                               <input name="7_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="7_id" value = "<?php echo $tl7->id; ?>">
                                        </div>

                                        <!-- 8 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>8. Selesai KP/PKL</b></label>
                                            <br><?php $tl8 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"8"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="8_start" type="date" value="<?php echo $tl8->date_start; ?>" class="form-control">
                                               <input name="8_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="8_id" value = "<?php echo $tl8->id; ?>">
                                        </div>

                                        <!-- 9 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>9. Bimbingan Bab IV, V dan Seminar</b></label>
                                            <br><?php $tl9 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"9"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="9_start" type="date" value="<?php echo $tl9->date_start; ?>" class="form-control">
                                            </div>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Berakhir</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="9_end" type="date" value="<?php echo $tl9->date_end; ?>" class="form-control">
                                            </div>
                                            <input type="hidden" name="9_id" value = "<?php echo $tl9->id; ?>">
                                        </div>

                                        <!-- 10 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>10. Batas akhir mengirim file Laporan Lengkap (COVER s.d Bab V)</b></label>
                                            <br><?php $tl10 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"10"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="10_start" type="date" value="<?php echo $tl10->date_start; ?>" class="form-control">
                                               <input name="10_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="10_id" value = "<?php echo $tl10->id; ?>">
                                        </div>

                                        <!-- 11 -->
                                        <div class="position-relative row form-group">
                                            <label for="prodi" class="col-sm-12 col-form-label"><b>11. Batas Akhir Seminar KP/PKL</b></label>
                                            <br><?php $tl11 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"11"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="11_start" type="date"  value="<?php echo $tl11->date_start; ?>" class="form-control">
                                               <input name="11_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="11_id" value = "<?php echo $tl11->id; ?>">
                                        </div>
                                         ...
                                         <div class="position-relative row form-group">
                                            ...
                                            <br><?php $tl12 = $this->pkl_model->get_pkl_periode_meta_row($pkl->id_pkl,"12"); ?>
                                            <label for="prodi" class="col-sm-3 col-form-label">&emsp;Tanggal Mulai</label>
                                            <div class="col-sm-1">:</div>
                                            <div class="col-sm-8">
                                               <input name="12_start" type="date" value="<?php echo $tl12->date_start; ?>" class="form-control">
                                               <input name="12_end" type="hidden" value=NULL class="form-control">
                                            </div>
                                            <input type="hidden" name="12_id" value = "<?php echo $tl12->id; ?>">
                                        </div>
                                        <br>
                                        <div class="position-relative row form-group">
