...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                <form method="post" action="<?php echo site_url('dosen/struktural/pkl/approve-pkl/save') ?>" >
                                    ...
                                    <!-- pembimbing -->
                                    <div class="position-relative row form-group">
                                            <label class="col-sm-3 col-form-label">Pembimbing KP/PKL</label>
                                            <div class="col-sm-9">
                                                <?php 
                                                    $dosen_pmb = $this->user_model->get_dosen_name($pkl->pembimbing);
                                                ?>
                                                <input value="<?php echo $dosen_pmb->gelar_depan." ".$dosen_pmb->name.", ".$dosen_pmb->gelar_belakang ?>" name="pembimbing" class="form-control input-mask-trigger" readonly >
                                            </div>
                                    </div>
                                    <!-- IPK -->
                                    <div class="position-relative row form-group">
