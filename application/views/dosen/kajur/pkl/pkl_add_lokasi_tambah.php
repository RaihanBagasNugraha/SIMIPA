                            ...
                            <table data-page-length='50' id="example" style="width: 100%;" class="table table-hover">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle = "modal" data-id="<?php echo "$row->id";?>" data-alamat="<?php echo "$row->alamat";?>" data-aksi-id="<?php echo "$id_aksi";?>" data-lokasi="<?php echo "$row->lokasi";?>" class="passingID2" ><span>
