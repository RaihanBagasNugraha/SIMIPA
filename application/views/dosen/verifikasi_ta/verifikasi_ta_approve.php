...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                <form method="post" action="<?php echo site_url('dosen/tugas-akhir/verifikasi-ta/form/save') ?>" >
                                    <input value="<?php echo $ta->id_pengajuan ?>" type = "hidden" required name="id_pengajuan" id="id_pengajuan">
                                    <input value="<?php echo $this->session->userdata('userId'); ?>" type = "hidden" required name="id_user" id="">
                                    ...
                                    <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php if($status == 'pa'){ echo "<input class=\"form-control\" value=\"Pembimbing Akademik\" name =\"status\" readonly>";}
                                                elseif($status== 'pb'){echo "<input class=\"form-control\" value=\"Pembimbing Utama\" name =\"status\" readonly>";} 
                                                elseif($status== 'kaprodi'){echo "<input class=\"form-control\" value=\"Ketua Program Studi\" name =\"status\" readonly>";}                                                
                                                ?>
                                            </div>
                                    </div>
