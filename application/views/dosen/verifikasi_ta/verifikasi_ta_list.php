                                        ...
                                        else
                                        {
                                            foreach($ta as $row) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="align-top">         
                                                            <a href="<?php echo site_url("dosen/tugas-akhir/verifikasi-ta/form?status=pb&id=".$this->encrypt->encode($row->id_pengajuan)) ?>" class="btn-wide mb-1 btn btn-primary btn-sm btn-block">Setujui
                                                            </a>                                          
                                                        </td>
                                            ...
                                            foreach($pa as $row){ ?>
                                                <tr>
                                                        ...
                                                        <td class="align-top">         
                                                            <a href="<?php echo site_url("dosen/tugas-akhir/verifikasi-ta/form?status=pa&id=".$this->encrypt->encode($row->id_pengajuan)) ?>" class="btn-wide mb-1 btn btn-primary btn-sm btn-block">Setujui
                                                            </a>                                          
                                                        </td>
