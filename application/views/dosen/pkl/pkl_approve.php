                                    ...
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="align-top">
                                                    Pembimbing<br>Akademik
                                                </td>

                                                <td class="align-top">

                                                <a href="<?php echo site_url("dosen/pkl/approve/setujui?status=pa&id=".$this->encrypt->encode($row->pkl_id)) ?>" class="btn-wide mb-1 btn btn-primary btn-sm btn-block">Setujui
                                                </a>
                                                
                                                <a data-toggle = "modal" data-id="<?php echo $row->pkl_id."#$#$"."pa" ?>" class="passingID4" >
                                                        <button type="button" class="btn mb-2 btn-wide btn-danger btn-sm btn-block"  data-toggle="modal" data-target="#Approvalperbaiki">
                                                            Perbaiki
                                                        </button>
                                                </a> 
                                                </td>
