                                ...
                                <div class="table-responsive">
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-top">
                                                <a href="<?php echo site_url("dosen/pkl/approve-seminar/form?status=pembimbing&id=".$this->encrypt->encode($row->seminar_id)) ?>" class="btn-wide mb-2 btn btn-primary btn-sm btn-block">Setujui
                                                </a>
                                                <a data-toggle = "modal" data-id="<?php echo $row->seminar_id ?>" data-status="pbb" class="passingID" >
                                                    <button type="button" class="btn mb-2 btn-wide btn-danger btn-sm btn-block"  data-toggle="modal" data-target="#PerbaikiSeminar">
                                                        Perbaiki
                                                    </button>
                                                </a>
                                            </td>
