...
<div class="app-page-title">
                        ...
                        <div class="col-md-12">
                         <div class="main-card mb-3 card">
                                ...
                                <div class="card-body">
                                <form method="post" action="<?php echo site_url('dosen/tugas-akhir/seminar/approve') ?>" >
                                    ...
                                    <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <?php if($status == 'pa'){ echo "<input class=\"form-control\" value=\"Pembimbing Akademik\" readonly>";}
                                                elseif($status == 'pb1'){echo "<input class=\"form-control\" value=\"Pembimbing Utama\" readonly>";}
                                                elseif($status == 'pb2'){echo "<input class=\"form-control\" value=\"Pembimbing 2\" readonly>";}
                                                elseif($status == 'pb3'){echo "<input class=\"form-control\" value=\"Pembimbing 3\" readonly>";}
                                                elseif($status == 'ps1'){echo "<input class=\"form-control\" value=\"Penguji 1\" readonly>";}
                                                elseif($status == 'ps2'){echo "<input class=\"form-control\" value=\"Penguji 2\" readonly>";}
                                                elseif($status == 'ps3'){echo "<input class=\"form-control\" value=\"Penguji 3\" readonly>";}?>
                                            </div>
                                    </div>
