                                ...
                                <div class="table-responsive">
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-top">
                                                <a href="<?php echo site_url("dosen/pkl/seminar-nilai/koordinator/form?id=".$this->encrypt->encode($row->seminar_id)) ?>" class="btn-wide mb-2 btn btn-primary btn-sm btn-block">Nilai
                                                </a>
                                            </td>
