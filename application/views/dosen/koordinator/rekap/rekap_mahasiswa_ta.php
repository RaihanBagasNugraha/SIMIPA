                                    ...
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="border-bottom:1pt solid black;"><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=ta&strata=d3&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_jml($id_user,$i,'0','0')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=ta&strata=s1&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_jml($id_user,$i,'1','5')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=ta&strata=s2&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_jml($id_user,$i,'2','2')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=ta&strata=d3&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_jml($id_user,$i,'3','3')->jml?></b></a></td>
                                                <td style="border-bottom:1pt solid black;"><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=lulus&strata=d3&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_lulus($id_user,$i,'0','0')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=lulus&strata=s1&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_lulus($id_user,$i,'1','5')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=lulus&strata=s2&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_lulus($id_user,$i,'2','2')->jml?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/mahasiswa-ta/detail?detail=lulus&strata=s3&angkatan=$i")?>"><b><?php echo $this->ta_model->get_mahasiswa_ta_rekap_lulus($id_user,$i,'3','3')->jml?></b></a></td>
