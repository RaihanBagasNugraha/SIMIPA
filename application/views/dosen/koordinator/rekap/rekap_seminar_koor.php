...
<div class="app-page-title">
                        ...
                        <!--Tugas Akhir -->     <td style="border-bottom:1pt solid black;"><b><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=ta&seminar=ta&angkatan=$i")?>"><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'0','0','Seminar Tugas Akhir')->jml ?></b></a><br><br><b>-</b><br><br><b>-</b><br><br><b>-</b></td>
                        <!--Usul -->            <td style="border-bottom:1pt solid black;"><b>-</b><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=skripsi&seminar=usul&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'1','5','Seminar Usul')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=tesis&seminar=usul&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'2','2','Seminar Usul')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=disertasi&seminar=usul&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'3','3','Seminar Usul')->jml ?></b></a></td>
                        <!--Hasil -->           <td style="border-bottom:1pt solid black;"><b>-</b><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=skripsi&seminar=hasil&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'1','5','Seminar Hasil')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=tesis&seminar=hasil&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'2','2','Seminar Hasil')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=disertasi&seminar=hasil&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'3','3','Seminar Hasil')->jml ?></b></a></td>
                        <!--kompre -->          <td style="border-bottom:1pt solid black;"><b>-</b><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=skripsi&seminar=kompre&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'1','5','Sidang Komprehensif')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=tesis&seminar=kompre&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'2','2','Sidang Komprehensif')->jml ?></b></a><br><br><a style="color: blue;" href="<?php echo site_url("dosen/koordinator/rekap/seminar/detail?jenis=disertasi&seminar=kompre&angkatan=$i")?>"><b><?php echo $this->ta_model->get_seminar_rekap_koor_jml($id_user,$i,'3','3','Sidang Komprehensif')->jml ?></b></a></td>
