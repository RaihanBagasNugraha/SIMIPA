                                    ...
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a href="<?php echo site_url("dosen/tugas-akhir/seminar/koordinator/form?status=koor&id=".$row->id) ?>" class="btn-wide mb-1 btn btn-primary btn-sm btn-block">Setujui
                                                </a>
