                                    ...
                                    <table class="mb-0 table table-striped" id="example">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <a href="<?php echo site_url("dosen/struktural/kaprodi/pkl/setujui?status=kaprodi&id=".$this->encrypt->encode($row->pkl_id)) ?>" class="btn-wide mb-1 btn btn-primary btn-sm btn-block">Setujui
                                                </a>
                                                </td>
                                            </tr>
                                        <?php
